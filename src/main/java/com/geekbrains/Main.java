...
public class Main {
    ...
    private static void fillArrayTwoThreads() {
        ...
        Thread runnableThread1 = new Thread(new fillArrayTask(a1));
        Thread runnableThread2 = new Thread(new fillArrayTask(a2));
    ...
    public static class fillArrayTask implements Runnable {
        private float[] arr;
        fillArrayTask(float[] arr){
            this.arr = arr;
        }
